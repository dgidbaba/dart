              ...
              ? SingleChildScrollView(
                  child: Wrap(
                    children: appStore.downloadedItemList.map((e) {
                      ...
                      return data.userId == getIntAsync(USER_ID) && !data.isDeleted.validate()
                          ? Container(
                              ...
                              child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  8.height,
                                  Text(parseHtmlString(data.title.validate()), style: boldTextStyle(size: 18), maxLines: 2, overflow: TextOverflow.ellipsis),
                                  4.height,
